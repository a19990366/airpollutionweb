...
<div id="content">
    ...
    <div id="form">
        <form id="form1" runat="server">
            ...
            <asp:GridView ID="GridView1" runat="server" CssClass="conter" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="account" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand" Height="404px" Width="941px">
                ...
                <EmptyDataTemplate>
                    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CellPadding="4" DataKeyNames="account" DataSourceID="SqlDataSource1" DefaultMode="Insert" GridLines="Horizontal" Height="37px" Width="202px" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px">
